...
public class OrdersServicesEndpoint {
	...
	public void deleteOrderItem(Callback<Object> callback, @PathVariable("orderId") String orderId,
		...
		// 调试日志
		logger.debug("Delete orderItem :orderId is:{},orderItemId is:{},param is {}", orderId, orderItemId, body);
	 ...
	 * @param action 统一或拒绝
	 */
	@RequestMapping(value = "/orders/{orderId}/confirm/{action}", method = RequestMethod.GET)

...
public class ShoppingCartsServicesEndpoint {
	...
	public void deleteShoppingCartItem(Callback<Object> callback, @PathVariable("userId") String userId,
			@PathVariable("skuCode") String skuCode, Map<String, String> body) {

		// 调试日志
		logger.debug("Delete shoppingCartItem :userId is:{},skuCode is:{},param is {}", userId, skuCode, body);
	 ...
	 * @param body
	 */
	@RequestMapping(value = "/users/{userId}/shoppingcarts/orderItems/{skuCode}/{number}", method = RequestMethod.POST)
	...
	public void deleteShoppingCarts(Callback<Object> callback, @PathVariable("userId") String userId,
		...
		// 调试日志
		logger.debug("Delete shoppingCarts :userId is:{},param is {}", userId, body);
